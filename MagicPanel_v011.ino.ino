...
void runPattern(int pattern) {
  ...
  switch (pattern) {
        ...
        {
          allOFF();
          alwaysOn ? Alert(1): Alert(10);    // (EO - CHANGED FROM 20 TO 10; SCREAM, ALERT 10 SECS)
          RandomTime = RandomOnTime + 1;  
          turnOff();
          break;
        }         
        ...
        {
          allOFF();
          alwaysOn ? CylonRow(1, 140): CylonRow(17, 140);  //(EO - CHANGED FROM 2 TO 17; LEIA MESSAGE 35 SECS)
          RandomTime = RandomOnTime + 1;  
          turnOff();
          break;
        }
        ...
        {
          alwaysOn ? FlashV(1, 200): FlashV(436, 200);  //(EO - CHANGED FROM 8 TO 436; IMPERIAL MARCH 190 SECS)
          RandomTime = RandomOnTime + 1;  
          turnOff();
          break;
        }
        ...
        {
          if (firstTimeCode) allOFF();
          alwaysOn ? TwoLoop(1): TwoLoop(24);  //(EO - CHANGED FROM 2 TO 24; CANTINA/PARODY/MANDO 60 SECS)
          RandomTime = RandomOnTime + 1;  
          turnOff();
          break;
        }
        ...
        {
          allOFF();
          alwaysOn ? Quadrant(1, 3): Quadrant(386, 3); //(EO - CHANGED FROM 5 TO 386; STAR WARS 5:35 MINS)
          RandomTime = RandomOnTime + 1;  
          turnOff();
          break;
        } 
        ...
        {
          if (firstTimeCode) allOFF();
          alwaysOn ? CheckerBoard(1, 200): CheckerBoard(800, 200);  //(EO - CHANGED FROM 8 TO 800)
          RandomTime = RandomOnTime + 1;
          turnOff();  
          break;
        }    
